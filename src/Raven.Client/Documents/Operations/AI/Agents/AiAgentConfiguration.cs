...
public class AiAgentConfiguration : IDynamicJson
{
    ...
    /// <summary>
    /// A list of parameterized semantic queries that the AI agent can use to fetch relevant data.
    /// </summary>
    ...
    /// <summary>
    /// Controls persistence behavior of chats (collection name and expiration).
    /// </summary>
