...
public class DatabaseAiAgents
{
    ...
    public Task<ChatResult<TSchema>> StartChatAsync<TSchema>(string agentName, string prompt, Func<RagAiBuilder, RagAiBuilder> func) where TSchema : new()
    {
    ...
    /// <param name="func">A builder function to define RAG parameters.</param>
    /// <returns>The result of the chat.</returns>
    public ChatResult<TSchema> StartChat<TSchema>(string agentName, string prompt, Func<RagAiBuilder, RagAiBuilder> func) where TSchema : new()
    {
        var builder = func.Invoke(new RagAiBuilder());
        var parameters = builder.GetParameters();
    ...
    {
        return await _store.Maintenance.ForDatabase(_databaseName).SendAsync(new StartChatOperation<TSchema>(agentName, agentName, parameters)).ConfigureAwait(false);
    }
    ...
    {
        return _store.Maintenance.ForDatabase(_databaseName).Send(new StartChatOperation<TSchema>(agentName, agentName, parameters));
    }
    ...
    public Task<ChatResult<TSchema>> ContinueChatAsync<TSchema>(string chatId, string prompt, Func<RagAiBuilder, RagAiBuilder> func) where TSchema : new()
    {
        var builder = func.Invoke(new RagAiBuilder());
        var parameters = builder.GetParameters();
        return ContinueChatAsync<TSchema>(chatId, prompt, parameters);
    }
    ...
    /// <param name="func">A builder function to define RAG parameters.</param>
    /// <returns>The result of the continued chat.</returns>
    public ChatResult<TSchema> ContinueChat<TSchema>(string chatId, string prompt, Func<RagAiBuilder, RagAiBuilder> func) where TSchema : new()
    {
        var builder = func.Invoke(new RagAiBuilder());
        var parameters = builder.GetParameters();
        return ContinueChat<TSchema>(chatId, prompt, parameters);
    }
    ...
    /// <param name="func">A builder function to define RAG parameters.</param>
    /// <returns>The result of the continued chat.</returns>
    public async Task<ChatResult<TSchema>> ContinueChatAsync<TSchema>(string chatId, string prompt, Dictionary<string, object> parameters = null) where TSchema : new()
    {
        return await _store.Maintenance.ForDatabase(_databaseName).SendAsync(new ResumeChatOperation<TSchema>(chatId, prompt, parameters)).ConfigureAwait(false);
    }
    ...
    /// <param name="func">A builder function to define RAG parameters.</param>
    /// <returns>The result of the continued chat.</returns>
    public ChatResult<TSchema> ContinueChat<TSchema>(string chatId, string prompt, Dictionary<string, object> parameters = null) where TSchema : new()
    {
        return _store.Maintenance.ForDatabase(_databaseName).Send(new ResumeChatOperation<TSchema>(chatId, prompt, parameters));
    }
