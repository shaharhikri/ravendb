...
namespace Raven.Server.Documents
{
    public class RevisionsBinCleaner : BackgroundWorkBase
    {
        ...
        public class RevisionsBinCleanerState
        {
            ...
            public RevisionsBinCleanerState Clone()
            {
                return new RevisionsBinCleanerState
                {
                    Skip = Skip, 
                    Etag = Etag
                };
            ...
            private bool Equals(RevisionsBinCleanerState other)
            {
            ...
            public override bool Equals(object obj)
            {
                ...
                if (obj.GetType() != GetType())
                    return false;
                return Equals((RevisionsBinCleanerState)obj);
            }
            ...
            public override int GetHashCode()
            {
                unchecked
                {
                    return (Skip.GetHashCode() * 397) ^ Etag.GetHashCode();
                }
            }
        }
